...
}function G(){var ah=window.location.hash;var ag=ah.slice(2).split("index.html"),ae=ah.replace(/#|\//gi,"");if(isNaN(parseInt(ag[0],10))&&ae.length){var ac=document.querySelector("#"+ae);
if(ac){var ai=Reveal.getIndices(ac);K(ai.h,ai.v);}else{K(k,c);}}else{var af=parseInt(ag[0],10)||0,ad=parseInt(ag[1],10)||0;K(af,ad);}}function f(){if(M.history){var ac="index.html";
